...
import { lenovoWarrantyLookupData } from './data';

interface LenovoWarrantyLookupProps {
  isExpanded: boolean;
  onToggle: () => void;
}

export default function LenovoWarrantyLookup({ isExpanded, onToggle }: LenovoWarrantyLookupProps) {
  const { title, category, description, tech, codeExcerpts, features, patterns, githubUrl } = lenovoWarrantyLookupData;
      ...
      >
        <div className="p-6 pb-8">
          <div className="space-y-6">
            ...
            {/* Features */}
            <div>
              <h4 className="text-sm font-bold text-white mb-4">Highlights</h4>
