...
import { excelFileProcessorData } from './data';

interface ExcelFileProcessorProps {
  isExpanded: boolean;
  onToggle: () => void;
}

export default function ExcelFileProcessor({ isExpanded, onToggle }: ExcelFileProcessorProps) {
  const { title, category, description, tech, codeExcerpts, features, patterns, githubUrl } = excelFileProcessorData;
