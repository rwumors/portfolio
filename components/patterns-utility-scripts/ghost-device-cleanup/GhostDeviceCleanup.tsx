...
import { ghostDeviceCleanupData } from './data';

interface GhostDeviceCleanupProps {
  isExpanded: boolean;
  onToggle: () => void;
}

export default function GhostDeviceCleanup({ isExpanded, onToggle }: GhostDeviceCleanupProps) {
  const { title, category, description, tech, codeExcerpts, features, patterns, githubUrl } = ghostDeviceCleanupData;
