...
import { assetPingDnsResolverData } from './data';

interface AssetPingDnsResolverProps {
  isExpanded: boolean;
  onToggle: () => void;
}

export default function AssetPingDnsResolver({ isExpanded, onToggle }: AssetPingDnsResolverProps) {
  const { title, category, description, tech, codeExcerpts, features, patterns, githubUrl } = assetPingDnsResolverData;
